...
- Name: Chrome Extension Tests >> id가 "inline-element"인 단락에서 "element</strong> in text." 텍스트를 선택 후 하이라이트 동작 검증
- Location: /home/runner/work/highweb/highweb/e2e-tests/highlight.spec.js:174:7
