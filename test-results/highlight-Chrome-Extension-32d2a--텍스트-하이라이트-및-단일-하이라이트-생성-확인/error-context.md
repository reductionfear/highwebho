...
- Name: Chrome Extension Tests >> 동적으로 생성된 멀티 텍스트 노드 단락을 트리플 클릭하여 하이라이트 - 전체 텍스트 하이라이트 및 단일 하이라이트 생성 확인
- Location: /home/runner/work/highweb/highweb/e2e-tests/highlight.spec.js:56:7
