...
- Name: Chrome Extension Tests >> p 태그 트리플 클릭 후 노란색 하이라이트, 새로고침 후 p 태그 안의 "in"만 하이라이트 유지, h1의 "in"은 하이라이트되지 않아야 함 (test-page4.html)
- Location: /home/runner/work/highweb/highweb/e2e-tests/highlight.spec.js:357:7
